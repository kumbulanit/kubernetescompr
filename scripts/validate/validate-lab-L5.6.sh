...
LAB_ID="L5.6"; LAB_DOC="labs/day5/L5.6-logs-and-alerts/"
...
grep -q 'correlation_id' "$R/charts/observability/alloy-values.yaml" && \
  grep -A2 'target_label' "$R/charts/observability/alloy-values.yaml" | grep -q 'correlation_id' \

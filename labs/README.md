...
| Day | Topic | Labs |
|---|---|---|
| [day1/](day1/) | [Foundations and core objects](../topics/01-foundations-and-core-objects/) | L1.1 – L1.6 + INC-1 |
| [day2/](day2/) | [Workloads, scaling and releases](../topics/02-workloads-scaling-and-releases/) | L2.1 – L2.6 + INC-2 |
| [day3/](day3/) | [Storage and configuration](../topics/03-storage-and-configuration/) | L3.1 – L3.7 + INC-3 |
| [day4/](day4/) | [Networking and exposure](../topics/04-networking-and-exposure/) | L4.1 – L4.6 + INC-4 |
| [day5/](day5/) | [Security, packaging and operations](../topics/05-security-packaging-and-operations/) | L5.1 – L5.6 |
...
Work them in order. The [lab roadmap](../documents/reference/03-LAB-ROADMAP.md) gives
the timings and says which labs depend on which, and the
[dependency map](../documents/reference/02-DEPENDENCY-MAP.md) shows why the order is
what it is.

Answers to every challenge and bonus exercise are in each topic's `solutions.md` —
for example [`topics/03-storage-and-configuration/solutions.md`](../topics/03-storage-and-configuration/solutions.md).

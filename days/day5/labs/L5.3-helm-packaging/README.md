...
The chart itself is [`charts/axispay/`](../../../../platform/charts/axispay/) — it is a shared artefact rather than a per-lab copy, and [`charts/README.md`](../../../../platform/charts/README.md) explains its design.

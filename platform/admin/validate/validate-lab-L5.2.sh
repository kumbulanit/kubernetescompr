...
LAB_ID="L5.2"; LAB_DOC="days/day5/labs/L5.2-rbac/"
...
python3 "$D/simulate-rbac.py" >/dev/null 2>&1 \
  ...
  || fail "simulate-rbac.py reports failures" "all assertions holding" "python3 platform/admin/validate/simulate-rbac.py"

...
LAB_ID="L4.4"; LAB_DOC="days/day4/labs/L4.4-networkpolicy/"
...
python3 "$R/platform/admin/validate/simulate-netpol.py" >/dev/null 2>&1 \
  && pass "all 39 policy assertions hold" \
  || fail "policy simulation failed" "39/39" "python3 platform/admin/validate/simulate-netpol.py"
summary

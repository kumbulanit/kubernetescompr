...
|---|---|---|---|
| [`INC-5-ticket.md`](./INC-5-ticket.md) | SEV-2 | 00:40 | `platform/admin/incidents/inject-INC-5.sh` |
| [`INC-6-ticket.md`](./INC-6-ticket.md) | SEV-2 | 00:52 | `platform/admin/incidents/inject-INC-6.sh` |
| [`INC-7-ticket.md`](./INC-7-ticket.md) | SEV-1 | 01:04 | `platform/admin/incidents/inject-INC-7.sh` |
